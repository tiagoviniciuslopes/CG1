...
union {
    ...
    */
    difference{
        ...
        #end
        box{
            <-14,1.2,22.5>,<-15,6,22.5+5.6>
            texture{ pigment{ color Black transmit 1}
               finish { ambient 0.9 phong 0.5}
            } // end of texture
        } 
        sphere{ 0, 1 scale<0,1.75,2.8>
            translate <-15,6,(22.5+(22.5+5.6))/2>
            pigment{ color Black transmit 1}
        }
        box{
            <-14,-9.8,22.5>,<-15,-4,22.5+5.6>
            texture{ pigment{ color Black transmit 1}
               finish { ambient 0.9 phong 0.5}
            } // end of texture
        } 
        sphere{ 0, 1 scale<0,1.75,2.8>
            translate <-15,-4,(22.5+(22.5+5.6))/2>
            pigment{ color Black transmit 1}
        }
        ...
        box{
            <14,1.2,22>,<15,6,22+6.6>
            texture{ pigment{ color Black transmit 1}
               finish { ambient 0.9 phong 0.5}
            } // end of texture
        } 
        sphere{ 0, 1 scale<0,1.9,3.3>
            translate <15,6,(22+(22+6.6))/2>
            pigment{ color Black transmit 1}
        }
        box{
            <14,-9.8,22>,<15,-4,22+6.6>
            texture{ pigment{ color Black transmit 1}
               finish { ambient 0.9 phong 0.5}
            } // end of texture
        } 
        sphere{ 0, 1 scale<0,1.9,3.3>
            translate <15,-4,(22+(22+6.6))/2>
            pigment{ color Black transmit 1}
        }
    ...
    difference{
        ...
        box{
            <-12,1.2,22>,<-18,6,22+6.6>
            pigment{ color Black  transmit 1}
        } 
    }
    box{
        <-13,1.2,22>,<-15,6,22+6.6>
        texture{Glass3 }
    }
    difference{
        sphere{ 0, 1 scale<0,1.75,2.8>
        ...
        box{
            <-12,-9.8,22.5>,<-18,-4,22.5+5.6>
            //pigment{ color Black  transmit 1}
        } 
    }
    box{
        <-13,-9.8,22.5>,<-15,-4,22.5+5.6>
        texture{Glass3 }
    } 
